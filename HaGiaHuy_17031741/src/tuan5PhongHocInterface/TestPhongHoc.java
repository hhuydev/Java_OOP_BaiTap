...
public class TestPhongHoc {
	...
	public static void nhapCung() throws Exception {
		...
		PhongHoc phong2 = new PhongLyThuyet("14f", "B4", 110f, 30, true);
		PhongHoc phong3 = new PhongMayTinh("12b", "E2", 120f, 10, 60);
		PhongHoc phong4 = new PhongMayTinh("13e", "X3", 100f, 20, 90);
		PhongHoc phong5 = new PhongThiNghiem("13c", "X3", 100f, 20, "Môi trường", 100, true);
		PhongHoc phong6 = new PhongThiNghiem("14d", "V12", 100f, 20, "Môi trường", 100, true);
		...
		try {
			do {
				...
				case 13:
					...
					break;
				case 14:
					System.out.println("Tổng số phòng học: " + qlPhongHoc.tongPhongHoc());
					break;
	...
	public static PhongHoc nhapTayPhongThiNghiem() {
		...
		try {
			...
			((PhongThiNghiem) ph).setChuyenNghanh(chuyenNganh);
			System.out.println("Nhập sức chứa phòng: ");
			sucChua = sc.nextInt();
			((PhongThiNghiem) ph).setSuaChua(sucChua);
